  ...
  return (
    <>
      <nav className="bg-[#1d1d20] w-[100%] p-4 sm:p-6 fixed left-0 right-0 top-0  z-[9999]  flex justify-between text-[#cacaca]  ">
        ...
        <div
          className={`min-h-screen overflow-y-hidden absolute top-16 left-0 w-full z-[99999] p-4 bg-[#1d1d20] px-8 lg:hidden transform transition-all duration-500 ease-in-out ${toggle ? "translate-x-0" : "-translate-x-full"
            }`}
        >
